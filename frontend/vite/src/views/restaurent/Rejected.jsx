...
const rejected = [
  { 
    ...
    phone: "+91 9876543215", 
    email: "nonveghouse@email.com", 
    rejectedDate: "2024-01-12", 
    reason: "Incomplete documents",
    daysSinceRejection: 8
  },
  { 
    id: 7, 
    ...
    foodCategory: "Mixed", 
    phone: "+91 9876543216", 
    email: "streetfood@email.com", 
    rejectedDate: "2024-01-08", 
    reason: "License issues",
    daysSinceRejection: 12
  },
];
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2.5 }}>
                          ...
                          <Box>
                            ...
                            <Typography variant="body2" color="text.secondary">
                              Rejected {row.daysSinceRejection} days ago
                            </Typography>
                          </Box>
                        </Box>
                      </TableCell>
